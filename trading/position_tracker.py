    ...
    try:
        ...
        for p in positions:
            ...
            if open_date is not None:
                ...
                # Opening Range "Peace Period": No exits before 06:40 AM PT
                if now.hour < 6 or (now.hour == 6 and now.minute < 40):
                    logger.debug("Skipping exit check for %s (opening range peace period until 06:40 AM PT)", sym)
                    continue
