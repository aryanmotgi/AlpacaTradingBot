...
SIGNAL_THRESHOLD = 1  # need |score| >= 1 for BUY_CALL / BUY_PUT (Sync with Rishab Bot)
...
FRIDAY_CLOSE_HOUR = 12  # 12:00 PM PT - close all positions
...
PREMARKET_SCAN_TIME = "06:00"   # 6:00 AM PT (9:00 AM ET)
PREMARKET_MISFIRE_GRACE_SEC = 3600  # allow up to 60 min late execution after downtime/sleep
MARKET_OPEN_SCAN_TIME = "06:45" # 6:45 AM PT (9:45 AM ET)
MARKET_CLOSE_HOUR = 13         # 1:00 PM PT (4:00 PM ET)
DAILY_SUMMARY_TIME = "13:15"   # 1:15 PM PT (4:15 PM ET)
